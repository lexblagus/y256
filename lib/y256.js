...
self.y256 = { // y256 is the x128 front end framework
	...
	options : {
		...
		pageLoadDelay    : 1, // 15* 60 * 1000, // use 1 for production. Delay on AJAX calls
		initDelay        : 500,                 // init function in each page
		fadeTime         : 250,                 // animation
		fadeOpacity      : 0.25,                // animation opacity
		ajaxContainer    : 'main',
		message          : {
	...
	// ————————————————————————————————————————————————————————————————————————————————
	model : {}, // main container for data objects
	// ————————————————————————————————————————————————————————————————————————————————
	...
	core:{
		...
		// — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — 
		pageLoad : function(addr , callback){
			l.info('y256.core.pageLoad' , arguments);
			
			l.log('Go to "'+addr+'" in '+y256.options.pageLoadDelay+'ms');
			
			if(!callback){ callback=function(){}; }

			$(y256.options.ajaxContainer).fadeTo(
				y256.options.fadeTime,
				y256.options.fadeOpacity,
				function(){
					l.info('y256.core.pageLoad (fadeTo callback)' , arguments);
					// raise your loading flag here
					setTimeout(
						function(){
							l.info('y256.core.pageLoad (setTimeout callback)' , arguments);
							l.log('this.addr', this.addr);
							$(y256.options.ajaxContainer).load(
								this.addr,
								function(){
									this.callback.call();
									y256.core.pageLoadComplete.apply( arguments );
								}.bind(
									{
		...
		// — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — 
		pageLoadComplete : function(response, status, jqXHR){
			l.info('y256.core.pageLoadComplete' , arguments);
			l.log('status=',status);
			
			if(status == 'success'){
				//y256.core.message.closeOnPageChange();
		...
		ajaxComplete : function(jqXHR, textStatus){
			...
			$(y256.options.ajaxContainer).fadeTo(y256.options.fadeTime, 1);
		},
		// — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — 
	},
	// ————————————————————————————————————————————————————————————————————————————————
...
// =============================================================================
// boot
//$(document).ready(  setTimeout( y256.core.init , y256.options.initDelay )  );
